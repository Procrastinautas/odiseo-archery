...
export function SessionActions({ trainingSessionId }: Props) {
  ...
  return (
    <div className="flex flex-col gap-2">
      <Button type="button" variant="outline" onClick={handleAddRound} disabled={isPending} className="w-full">
        <Plus className="h-4 w-4 mr-2" />
        Agregar ronda
      </Button>
      <Button type="button" onClick={handleFinalize} disabled={isPending} className="w-full">
