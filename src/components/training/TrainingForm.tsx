...
export function TrainingForm({ session, bows, arrows }: Props) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <AIAdviceBanner trainingSessionId={session.id} initialAdvice={session.ai_advice} />
        ...
        <CardContent className="flex flex-col gap-4 pt-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Select
              ...
              onValueChange={(v) => { setValue('type', (v as unknown) as FormValues['type']) }}
            >
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Select
              ...
              onValueChange={(v) => { setValue('weather', (v as unknown) as FormValues['weather']) }}
            >
              <SelectTrigger><SelectValue placeholder="Selecciona el clima" /></SelectTrigger>
              <SelectContent>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            >
              <SelectTrigger><SelectValue placeholder="Selecciona un arco" /></SelectTrigger>
              <SelectContent>
                {bows.map((bow) => (
          ...
          <div className="flex flex-col gap-1.5">
            ...
            >
              <SelectTrigger><SelectValue placeholder="Selecciona flechas" /></SelectTrigger>
              <SelectContent>
                {arrows.map((arrow) => (
                  <SelectItem key={arrow.id} value={arrow.id}>
                    {arrow.brand}{arrow.diameter_mm ? ` · ${arrow.diameter_mm}mm` : ''}
                  </SelectItem>
                ))}
              </SelectContent>
            </Select>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Textarea placeholder="Pensamientos finales sobre la sesión..." rows={3} {...register('final_thoughts')} />
          </div>
        </CardContent>
      </Card>
    </div>
